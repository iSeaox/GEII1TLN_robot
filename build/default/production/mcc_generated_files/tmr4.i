...
# 54 "mcc_generated_files/tmr4.c" 2
...
float R0;
float R1;
# 230 "mcc_generated_files/tmr4.c"
float DMG;
float DMD;

void TMR4_DefaultInterruptHandler(void){
# 265 "mcc_generated_files/tmr4.c"
       Erreur_Vitesse_Moteur_G = Consigne_Vitesse_Moteur_G - Vitesse_Moteur_G;
       dutyValue_G = (float)ancien_dutyValue_G + 20.2 * (float) Erreur_Vitesse_Moteur_G + -19.8 * (float) Ancienne_Erreur_Vitesse_Moteur_G;
       ...
       dutyValue_D = (float) ancien_dutyValue_D + 20.2 * (float) Erreur_Vitesse_Moteur_D + -19.8 * (float) Ancienne_Erreur_Vitesse_Moteur_D;
...
# 309 "mcc_generated_files/tmr4.c"
}
