...
extern void initLCD(){
    ...
    _delay((unsigned long)((5)*(64000000/4000.0)));
# 71 "drivers/LCD.c"
    writeLCD(((0b0010 << 4) | (1 << 3)), COMMAND);
    _delay((unsigned long)((5)*(64000000/4000.0)));
    writeLCD(((0b1100) | (0 << 1) | (0 << 0)), COMMAND);
    _delay((unsigned long)((8)*(64000000/4000.0)));
    clearLCD();
    _delay((unsigned long)((5)*(64000000/4000.0)));
    writeLCD(0x06, COMMAND);
    _delay((unsigned long)((5)*(64000000/4000.0)));
    clearLCD();
...
static void lcdNibble(uint8_t nibble){
    LATAbits.LATA2 = (nibble & 0x01) ? 1 : 0;
    LATAbits.LATA3 = (nibble & 0x02) ? 1 : 0;
    LATAbits.LATA4 = (nibble & 0x04) ? 1 : 0;
    LATEbits.LATE0 = (nibble & 0x08) ? 1 : 0;
...
static void lcdByte(uint8_t byte){
    ...
    LATAbits.LATA2 = (byte & 0x10) ? 1 : 0;
    LATAbits.LATA3 = (byte & 0x20) ? 1 : 0;
    LATAbits.LATA4 = (byte & 0x40) ? 1 : 0;
    LATEbits.LATE0 = (byte & 0x80) ? 1 : 0;
