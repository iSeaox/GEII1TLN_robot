...
void main(void)
{
    ...
    uint8_t stateSequence[11] = {4, 1, 1, 1, 2, 4, 2, 2, 2, 1, 3};
    int currentSeq = 0;
    while (1) {
        ...
        uint16_t aValCenter = ADCC_GetSingleConversion(30);
        uint16_t aValRight = ADCC_GetSingleConversion(29);
        uint16_t aValLeft = ADCC_GetSingleConversion(31);

        uint8_t cptDLeft = Digital_read(0);
        uint8_t cptDRight = Digital_read(1);
